...
const authFoundationKeys=["DATABASE_URL","BETTER_AUTH_SECRET","BETTER_AUTH_URL","AUTH_MODE"];
...
const missingTemplate=[...authFoundationKeys,...requiredForBeta,...approvalKeys,"ENABLE_REGISTRATION"].filter((key)=>!keys.includes(key));
